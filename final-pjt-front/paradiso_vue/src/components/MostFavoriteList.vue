  ...
  <div class="margin-by-fixed" style="position: relative">
    ...
    <div class="d-flex poster-container" id="most-favorite-box">
      <div
        ...
        :key="mostFavorite.id"
        class="col-2"
        id="most-favorite-item"
      >
        <MostFavoriteListItem
          :mostFavorite="mostFavorite"
          @click.native="goToMovie(mostFavorite.id)"
          style="cursor: pointer"
        />
      </div>
    </div>
    <i
      class="fa-solid fa-chevron-left fa-2x arrow-left cursor-pointer"
      @click="scrollLeft"
    ></i>
    <i
      class="fa-solid fa-chevron-right fa-2x arrow-right cursor-pointer"
      @click="scrollRight"
    ></i>
  </div>
</template>
